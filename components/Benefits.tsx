    ...
    let ctx = gsap.context(() => {
      ...
      gsap.fromTo(`.${styles.item}`,
        { y: 50, opacity: 0 },
        {
          ...
          scrollTrigger: { trigger: `.${styles.grid}`, start: 'top 78%', toggleActions: 'play none none reverse' },
        }
      );
    }, comp);
    return () => ctx.revert();
