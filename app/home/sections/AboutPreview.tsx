    ...
    let ctx = gsap.context(() => {
      ...
      gsap.fromTo(`.${styles.introBox}`,
        { y: 50, opacity: 0 },
        {
          ...
          scrollTrigger: { trigger: `.${styles.introBox}`, start: 'top 85%' },
        }
      );
  ...
  return (
    <section id="about" className={styles.about} ref={comp}>
      <div className="container">
        ...
        {/* Cooperative Overview Intro */}
        <div className={styles.introBox}>
          <span className="subheading" style={{ color: 'var(--c-gold)' }}>
            {t("Notre Coopérative", "تعاونيتنا")}
          </span>
          <h2 className={styles.mainTitle}>
            {t(
              "Née au cœur des terres du Souss-Massa, notre coopérative abrite l'or véritable du Maroc.",
              "نشأت في قلب أراضي سوس ماسة، تحتضن تعاونيتنا الذهب الحقيقي للمغرب."
            )}
          </h2>
        </div>
